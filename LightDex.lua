...
-- Properties
print "Revamped by kqrmas in discord LMFAO"
			...
			elseif option == "Teleport To" then
				...
				for i = 1,#list do
					if list[i]:IsA("BasePart") then
						pcall(function()
							owner.Character.HumanoidRootPart.CFrame = list[i].CFrame
						end)
						break
					end
				end
			elseif option == "Insert Part" then
				...
				for i = 1,#list do
					pcall(function()
						...
						newPart.CFrame = CFrame.new(owner.Character.Head.Position) + Vector3.new(0,3,0)
